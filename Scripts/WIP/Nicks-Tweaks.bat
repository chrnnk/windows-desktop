@ echo off
@ This executable batch file removes unnecessary bloatware that comes preinstalled on Windows 10 and executes registry tweaks 
title Optimization
echo Executing prerequisites...
echo Windows Optimizer Loading...
echo 
